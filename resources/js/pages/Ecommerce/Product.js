                ...
                <div className="row">
                    ...
                    <div className="col-lg-6 flex items-center">
                        <div className="product-brief">
                            <h1 className="product-name">Protecting CC Cream</h1>
                            <h2 className="product-price">Rp. 200.000</h2>
                            <h3 className="product-shor-desc">Lorem ipsum dolor sit amet consectetur adipisicing elit. Nihil ipsam saepe tempore ad eum nostrum, beatae accusamus temporibus sed, autem aperiam ipsum nemo pariatur tempora magnam repudiandae, perspiciatis nulla enim?
                                Rerum necessitatibus sint laudantium qui accusamus vitae voluptatibus quo, iure ratione voluptatum. Quae vel facilis ea voluptas error, dicta dolores pariatur quidem? Voluptatibus dolor vel voluptatum, ut accusamus eos sapiente?</h3>
